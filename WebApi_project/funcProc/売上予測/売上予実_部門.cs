...
namespace WebApi_project.hostProc
{
    ...
    {
        public object json_売上予実_部門(String Json)
        {
            ...
            string url = "http://kansa.in.eandm.co.jp/Project/売上予測/xml/売上予実_部門_JSON.asp?year=2021";
        ...
        public XmlDocument 売上予実_部門(String Json)
        {
            ...
            object json_data = json_売上予実_部門(Json);
