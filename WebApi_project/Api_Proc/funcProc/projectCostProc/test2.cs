...
namespace WebApi_project.hostProc
{
    public partial class projectCostProc : hostProc
    {
        ...
        public XmlDocument projectInfoDetail(String Json)
        {
        ...
        public XmlDocument projectInfoDetail_xml(String Json)
        {
            ...
            url = "http://kansa.in.eandm.co.jp/Project/projectCostProc/xml/projectInfo_XML_Detail.asp?pNum=20212329";
            xmlDoc.Load(url);
            return (xmlDoc);
        }
    }
