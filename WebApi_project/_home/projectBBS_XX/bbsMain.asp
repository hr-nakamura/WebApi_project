...
<%
var visitBBS = readCookies("visitBBS");
visitBBS = convertDateTime(visitBBS);
...
<HEAD>
   ...
   <script src="js/bbsMain.js" type="text/javascript"></script>
   <TITLE></TITLE>
<SCRIPT LANGUAGE="JavaScript">
var visitBBS = "<%=visitBBS%>"
//alert($.fn.jquery)
</SCRIPT>
<STYLE>
td{
...
<DIV style="text-align:right"><%=visitBBS%></DIV>
<DIV class="status" style="text-align:right"></DIV>
...
function editProject(pNum)
   ...
   parent_pNum = pNum
   dispEditProject(URL, para, title, width, height)
   //value = window.showModalDialog(URL,Buff,windowOption)
   //pNum = Buff.pNum

   //if( return_value ) updateList(pNum)
   }
