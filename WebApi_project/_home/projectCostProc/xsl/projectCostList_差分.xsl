  ...
  <xsl:template match="/">
        <html>
          ...
          <body background="bg.gif">
            <xsl:choose>
              <xsl:when test="count(root/全体/プロジェクト) = 0">
                <table align="center" border="0">
                  <tr>
                    <td>
                      <span>
                        <xsl:attribute name="style">
                          <xsl:value-of select="'color:black;font-weight:bold;'"/>
                        </xsl:attribute>
                        <xsl:value-of select="'担当しているプロジェクトはありません'"/>
                      </span>
  ...
  <xsl:template name="HEAD">
    ...
    <tr>
      ...
      <!--<th style="padding:2 16 2 16;">
        ...
        <xsl:attribute name="order_name">
          <xsl:value-of select="'売上[@mode=$mode_予測]'"/>
        </xsl:attribute>
        <xsl:value-of select="'予測'"/>
      </th>
      <th style="padding:2 16 2 16;">
    ...
    <xsl:param name="pos" />
      <tr>
        ...
        <td class="num">
          --><!--売上--><!--
          <xsl:call-template name="value_Out">
            <xsl:with-param name="value" select="売上[@mode=$mode_予測]"/>
