...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template name="HEAD">
    <tr>
      ...
      <th colspan="4">
        <xsl:value-of select="'予実対比【(予測+実績)-予測】'"/>
      </th>
      <th colspan="3">
    ...
    <tr>
      <th style="padding:2 16 2 16;">
        ...
        <xsl:attribute name="order_name">
          <xsl:value-of select="'売上[@mode=$mode_予実]'"/>
        </xsl:attribute>
      ...
      <th style="padding:2 16 2 16;">
        ...
        <xsl:attribute name="order_name">
          <xsl:value-of select="'合計工数[@mode=$mode_予実]'"/>
        </xsl:attribute>
        <xsl:value-of select="'工数'"/>
      </th>
      <th style="padding:2 16 2 16;">
        ...
        <xsl:attribute name="order_name">
          <xsl:value-of select="'利益[@mode=$mode_予実]'"/>
        </xsl:attribute>
      ...
      <th style="padding:2 8 2 8;">
        ...
        <xsl:attribute name="order_name">
          <xsl:value-of select="'原価率[@mode=$mode_予実]'"/>
        </xsl:attribute>
        <xsl:value-of select="'原価率'"/>
      </th>
      ...
      <th style="padding:2 16 2 16;">
        ...
        <xsl:attribute name="order_name">
          <xsl:value-of select="'合計工数[@mode=$mode_差分]'"/>
        </xsl:attribute>
        <xsl:value-of select="'工数'"/>
      </th>
      <th style="padding:2 8 2 8;">
        ...
        <xsl:attribute name="order_name">
          <xsl:value-of select="'工数比率[@mode=$mode_差分]'"/>
        </xsl:attribute>
        <xsl:value-of select="'工数率'"/>
      </th>
      <th style="padding:2 16 2 16;">
        <xsl:attribute name="id">
          <xsl:value-of select="'sOrder'"/>
        ...
        <xsl:attribute name="order_name">
          <xsl:value-of select="'利益[@mode=$mode_差分]'"/>
        </xsl:attribute>
        <xsl:value-of select="'利益'"/>
      </th>
      <th style="padding:2 8 2 8;">
        ...
        <xsl:attribute name="order_name">
          <xsl:value-of select="'原価率[@mode=$mode_差分]'"/>
        </xsl:attribute>
        <xsl:value-of select="'原価率'"/>
      </th>
      ...
      <th style="padding:2 16 2 16;">
        ...
        <xsl:attribute name="order_name">
          <xsl:value-of select="'合計工数[@mode=$mode_予測]'"/>
        </xsl:attribute>
        <xsl:value-of select="'工数'"/>
      </th>
      <th style="padding:2 16 2 16;">
        ...
        <xsl:attribute name="order_name">
          <xsl:value-of select="'利益[@mode=$mode_予測]'"/>
        </xsl:attribute>
        <xsl:value-of select="'利益'"/>
      </th>
      <th style="padding:2 8 2 8;">
        ...
        <xsl:attribute name="order_name">
          <xsl:value-of select="'原価率[@mode=$mode_予測]'"/>
        </xsl:attribute>
        <xsl:value-of select="'原価率'"/>
      </th>
      ...
      <tr>
        ...
        <td class="num">
          ...
          <xsl:call-template name="value_Out">
            <xsl:with-param name="value" select="売上[@mode=$mode_予実]"/>
        ...
        <td class="num">
           <!--合計工数--> 
          <xsl:call-template name="value_Out">
            <xsl:with-param name="value" select="合計工数[@mode=$mode_予実]"/>
        ...
        <td class="num">
           <!--利益--> 
          <xsl:call-template name="value_Out">
            <xsl:with-param name="value" select="利益[@mode=$mode_予実]"/>
            <xsl:with-param name="unit" select="1000"/>
            <xsl:with-param name="form" select="'#,##0'"/>
          </xsl:call-template>
        </td>
        <td class="num">
           <!--原価率--> 
          <xsl:call-template name="value_Out">
            <xsl:with-param name="value" select="原価率[@mode=$mode_予実]"/>
...
<!--差分-->
        <td class="num">
          ...
          <xsl:call-template name="value_Out_Invert">
            <xsl:with-param name="value" select="合計工数[@mode=$mode_差分]"/>
            <xsl:with-param name="unit" select="100"/>
            <xsl:with-param name="form" select="'#,##0.00'"/>
          </xsl:call-template>
        </td>
        <td class="num">
          <!--工数比率-->
          <xsl:call-template name="value_Out">
            <xsl:with-param name="value" select="工数比率[@mode=$mode_差分]"/>
            <xsl:with-param name="unit" select="1"/>
            <xsl:with-param name="form" select="'0%'"/>
          </xsl:call-template>
        </td>
        <td class="num">
           <!--利益--> 
          <xsl:call-template name="value_Out">
            <xsl:with-param name="value" select="利益[@mode=$mode_差分]"/>
            <xsl:with-param name="unit" select="1000"/>
            <xsl:with-param name="form" select="'#,##0'"/>
          </xsl:call-template>
        </td>
        <td class="num">
           <!--原価率--> 
          <xsl:call-template name="value_Out">
            <xsl:with-param name="value" select="原価率[@mode=$mode_差分]"/>
            <xsl:with-param name="unit" select="1"/>
            <xsl:with-param name="form" select="'0%'"/>
          </xsl:call-template>
        </td>
...
<!--予測-->
        <td class="num">
           <!--合計工数--> 
          <xsl:call-template name="value_Out">
            <xsl:with-param name="value" select="合計工数[@mode=$mode_予測]"/>
            <xsl:with-param name="unit" select="100"/>
            <xsl:with-param name="form" select="'#,##0.00'"/>
          </xsl:call-template>
        </td>
        <td class="num">
           <!--利益--> 
          <xsl:call-template name="value_Out">
            <xsl:with-param name="value" select="利益[@mode=$mode_予測]"/>
            <xsl:with-param name="unit" select="1000"/>
            <xsl:with-param name="form" select="'#,##0'"/>
          </xsl:call-template>
        </td>
        <td class="num">
           <!--原価率--> 
          <xsl:call-template name="value_Out">
            <xsl:with-param name="value" select="原価率[@mode=$mode_予測]"/>
            <xsl:with-param name="unit" select="1"/>
            <xsl:with-param name="form" select="'0%'"/>
          </xsl:call-template>
        </td>
