...
<xsl:stylesheet version="1.0"
  ...
  <xsl:variable name="mode_当月" select="'当月'"/>
  <xsl:variable name="mode_前月" select="'前月'"/>
  <xsl:variable name="mode_増減" select="'増減'"/>
  <xsl:variable name="mode" select="'増減'"/>
  <xsl:variable name="actual" select="//実績月"/>
    ...
    <table class="disp" cellpadding="0" cellspacing="0" width="100%">
      ...
      <tbody>
        <xsl:for-each select="プロジェクト">
           <xsl:sort select="原価率[@mode=$mode_増減]" data-type="number" order="descending"/>
  ...
  <xsl:template name="HEAD">
    ...
    <tr>
      <th style="padding:2 16 2 16;">
        ...
        <xsl:attribute name="order_name">
          <xsl:value-of select="'売上[@mode=$mode_当月]'"/>
        </xsl:attribute>
      ...
      <th style="padding:2 16 2 16;">
        ...
        <xsl:attribute name="order_name">
          <xsl:value-of select="'合計工数[@mode=$mode_当月]'"/>
        </xsl:attribute>
        <xsl:value-of select="'工数'"/>
      </th>
      <th style="padding:2 16 2 16;">
        ...
        <xsl:attribute name="order_name">
          <xsl:value-of select="'利益[@mode=$mode_当月]'"/>
        </xsl:attribute>
      ...
      <th style="padding:2 8 2 8;">
        ...
        <xsl:attribute name="order_name">
          <xsl:value-of select="'原価率[@mode=$mode_当月]'"/>
        </xsl:attribute>
        <xsl:value-of select="'原価率'"/>
      </th>
      ...
      <th style="padding:2 16 2 16;">
        ...
        <xsl:attribute name="order_name">
          <xsl:value-of select="'売上[@mode=$mode_前月]'"/>
        </xsl:attribute>
        <xsl:value-of select="'売上'"/>
      </th>
      <th style="padding:2 16 2 16;">
        ...
        <xsl:attribute name="order_name">
          <xsl:value-of select="'合計工数[@mode=$mode_前月]'"/>
        </xsl:attribute>
        <xsl:value-of select="'工数'"/>
      </th>
      <th style="padding:2 16 2 16;">
        ...
        <xsl:attribute name="order_name">
          <xsl:value-of select="'利益[@mode=$mode_前月]'"/>
        </xsl:attribute>
        <xsl:value-of select="'利益'"/>
      </th>
      <th style="padding:2 8 2 8;">
        ...
        <xsl:attribute name="order_name">
          <xsl:value-of select="'原価率[@mode=$mode_前月]'"/>
        </xsl:attribute>
        <xsl:value-of select="'原価率'"/>
      </th>
      ...
      <th style="padding:2 16 2 16;">
        ...
        <xsl:attribute name="order_name">
          <xsl:value-of select="'売上[@mode=$mode_増減]'"/>
        </xsl:attribute>
        <xsl:value-of select="'売上'"/>
      </th>
      <th style="padding:2 16 2 16;">
        ...
        <xsl:attribute name="order_name">
          <xsl:value-of select="'合計工数[@mode=$mode_増減]'"/>
        </xsl:attribute>
        <xsl:value-of select="'工数'"/>
      </th>
      <th style="padding:2 16 2 16;">
        ...
        <xsl:attribute name="order_name">
          <xsl:value-of select="'利益[@mode=$mode_増減]'"/>
        </xsl:attribute>
        <xsl:value-of select="'利益'"/>
      </th>
      <th style="padding:2 8 2 8;">
        ...
        <xsl:attribute name="order_name">
          <xsl:value-of select="'原価率[@mode=$mode_増減]'"/>
        </xsl:attribute>
        <xsl:value-of select="'原価率'"/>
      </th>
  ...
  <xsl:template match="プロジェクト">
    <xsl:param name="pos" />
      <tr>
        <td class="C_Item">
          <xsl:call-template name="番号">
            <xsl:with-param name="Num" select="$pos"/>
            <xsl:with-param name="Disp" select="表示"/>
          </xsl:call-template>
        </td>
        ...
        <td class="num">
          ...
          <xsl:call-template name="value_Out">
            <xsl:with-param name="value" select="売上[@mode=$mode_当月]"/>
        ...
        <td class="num">
           <!--合計工数--> 
          <xsl:call-template name="value_Out">
            <xsl:with-param name="value" select="合計工数[@mode=$mode_当月]"/>
        ...
        <td class="num">
           <!--利益--> 
          <xsl:call-template name="value_Out">
            <xsl:with-param name="value" select="利益[@mode=$mode_当月]"/>
            <xsl:with-param name="unit" select="1000"/>
            <xsl:with-param name="form" select="'#,##0'"/>
          </xsl:call-template>
        </td>
        <td class="num">
           <!--原価率--> 
          <xsl:call-template name="value_Out">
            <xsl:with-param name="value" select="原価率[@mode=$mode_当月]"/>
...
<!--前月-->
        <td class="num">
          <!--売上-->
          <xsl:call-template name="value_Out">
            <xsl:with-param name="value" select="売上[@mode=$mode_前月]"/>
            <xsl:with-param name="unit" select="1000"/>
            <xsl:with-param name="form" select="'#,##0'"/>
          </xsl:call-template>
        </td>
        <td class="num">
          <!--合計工数-->
          <xsl:call-template name="value_Out">
            <xsl:with-param name="value" select="合計工数[@mode=$mode_前月]"/>
            <xsl:with-param name="unit" select="100"/>
            <xsl:with-param name="form" select="'#,##0.00'"/>
          </xsl:call-template>
        </td>
        <td class="num">
           <!--利益--> 
          <xsl:call-template name="value_Out">
            <xsl:with-param name="value" select="利益[@mode=$mode_前月]"/>
            <xsl:with-param name="unit" select="1000"/>
            <xsl:with-param name="form" select="'#,##0'"/>
          </xsl:call-template>
        </td>
        <td class="num">
           <!--原価率--> 
          <xsl:call-template name="value_Out">
            <xsl:with-param name="value" select="原価率[@mode=$mode_前月]"/>
            <xsl:with-param name="unit" select="1"/>
            <xsl:with-param name="form" select="'0%'"/>
          </xsl:call-template>
        </td>
...
<!--増減-->
        <td class="num">
          <!--売上-->
          <xsl:call-template name="value_Out">
            <xsl:with-param name="value" select="売上[@mode=$mode_増減]"/>
            <xsl:with-param name="unit" select="1000"/>
            <xsl:with-param name="form" select="'#,##0'"/>
          </xsl:call-template>
        </td>
        <td class="num">
          ...
          <xsl:call-template name="value_Out_Invert">
            <xsl:with-param name="value" select="合計工数[@mode=$mode_増減]"/>
            <xsl:with-param name="unit" select="100"/>
            <xsl:with-param name="form" select="'#,##0.00'"/>
          </xsl:call-template>
        </td>
        <td class="num">
           <!--利益--> 
          <xsl:call-template name="value_Out">
            <xsl:with-param name="value" select="利益[@mode=$mode_増減]"/>
            <xsl:with-param name="unit" select="1000"/>
            <xsl:with-param name="form" select="'#,##0'"/>
          </xsl:call-template>
        </td>
        <td class="num">
           <!--原価率--> 
          <xsl:call-template name="value_Out_Invert">
            <xsl:with-param name="value" select="原価率[@mode=$mode_増減]"/>
            <xsl:with-param name="unit" select="1"/>
            <xsl:with-param name="form" select="'0%'"/>
          </xsl:call-template>
        </td>
    ...
    <xsl:choose>
      <xsl:when test="$Disp = 0">
        ...
        <xsl:attribute name="memo">
          <xsl:value-of select="'表示除外の設定されています'"/>
        </xsl:attribute>
