...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:user="mynamespace">
  ...
  <xsl:template match="全体">
    <table BORDER="0" align='center' class='table' style='background-color:snow;'>
      <thead class='mounth'>
        <tr>
          <th rowspan="2">
