            ...
            case 1: // Simple element
                {
                    ...
                    for (var attrIdx = attributes.length - 1 ; attrIdx >= 0 ; attrIdx-- ) {
                    ...
                    if (hasChildNodes) {
                        ...
                        if (expandingNode) {
                            ...
                            var collapsedSpan = makeSpan("", "simpleXML-expanderClose");
                            parent.appendChild(collapsedSpan);
                        }
                        else {
                            parent.appendChild(makeSpan(xml.childNodes[0].nodeValue));
                            var collapsedSpan = parent;
                        }

                        // Closing tag
                        collapsedSpan.appendChild(makeSpan("</", "simpleXML-tagHeader"));
                        collapsedSpan.appendChild(makeSpan(xml.nodeName, "simpleXML-tagValue"));
                        collapsedSpan.appendChild(makeSpan(">", "simpleXML-tagHeader"));
                    } else {
